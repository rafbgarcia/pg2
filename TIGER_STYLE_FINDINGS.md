...
- Next recommended step:
  1. Extend grouped aggregate state/evaluation from `count(*)` to `sum/avg/min/max` with explicit state-capacity contracts and fail-closed overflow/type handling.
