...
- Next recommended step:
  1. Implement bounded aggregate function state/evaluation on top of grouped rows (`count/sum/avg/min/max`) with explicit state-capacity contracts and fail-closed overflow handling.
