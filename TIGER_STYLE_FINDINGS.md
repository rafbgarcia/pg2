...
- Still open:
  - Allocator-sealing migration is still `partial`; executor query-result/query-arena paths still need startup-carved memory wiring to avoid runtime allocator-backed result allocation.
