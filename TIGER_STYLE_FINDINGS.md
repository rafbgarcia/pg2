...
- Still open:
  - Allocator-sealing migration is still `partial`; server/request execution path is not wired yet to use runtime query-buffer slot acquire/release around executor calls.
