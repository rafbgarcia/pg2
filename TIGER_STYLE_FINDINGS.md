...
- Next recommended step:
  1. Implement bounded `group`/aggregate execution using explicit group/state capacity contracts (fail closed on key/state overflow).
