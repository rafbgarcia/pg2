...
- Still open:
  - Allocator-sealing migration is still `partial`; process-level allocator sealing policy is not yet enforced end-to-end at startup/runtime boundaries.
